...
import type { FileType, ImageDimensions, ImageResizeOptions } from '@/types/common';
...
export const downloadFromArrayBuffer = (arrayBuffer: any, fileName: string, fileType: string) => {
...
export const generateFileNameByExtesnsion = (
...
export const blobToFile = (b: Blob, originalFileName: string): Promise<File> => {
  return new Promise((resolve) => {
 ...
 * @param file - The image file from an HTML input element.
