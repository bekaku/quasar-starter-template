...
export const AppAuthTokenKey = '_auth';
export const AppAuthRefeshTokenKey = '_token';
export const AppAuthDataKey = '_authData';
export const AppAuthTokenExpireKey = '_tokenExpire';
export const AppAuthTokenCreatedKey = '_authCreated';
